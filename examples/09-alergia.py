...
def example_9():
    ...
    print(
        "Loglikelihood for Alergia output model:", alergia_model.logLikelihood(test_set)
    )
    ...
    for formula in formulas:
        ...
        print(
            ...
            result_original.at(original_model.initial_states[0]),
        )
        print(
            "In the Alergia output model:",
            result_alergia.at(alergia_model.initial_states[0]),
        )
