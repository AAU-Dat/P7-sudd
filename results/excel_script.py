...
input_file_path = 'results/results_philosophers_untimed.txt'
...
with open('results_philosophers_untimed.csv', 'w', newline='') as csvfile:
    csvwriter = csv.writer(csvfile)
    csvwriter.writerow(['Run', 'alpha', 'betax', 'zetax', 'Learning Rounds', 'Learning Time', 'Training Set Loglikelihood'])
    ...
    for run in runs:
        ...
        csvwriter.writerow([run_number, alpha, betax, zetax, learning_rounds, learning_time, training_set_loglikelihood])
